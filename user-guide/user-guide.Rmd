...
# if the species labels are off the plot, ...
...
4. **Format plot** using various inputs in sidebar and **download plot and table** as png and csv file, respectively. If the species labels are not fully visible within the plot, adjust the x-axis limits.
\
