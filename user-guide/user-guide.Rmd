...
3. Format the plot using inputs in the sidebar and **download plot** and **goodness of fit table** as a png and csv file, respectively.
\
...
4. **Format plot** using various inputs in sidebar and **download plot and table** as png and csv file, respectively. 
    ...
    + Qualitative colour palettes are from [ColorBrewer](http://colorbrewer2.org/#type=sequential&scheme=BuGn&n=3)

 <center>


![ColorBrewer qualitative palettes.](/Users/sebastiandalgarno/Poisson/Code/ssdtools-shiny/ssdtools-shiny/user-guide/cb-qual.png){width=400px}
