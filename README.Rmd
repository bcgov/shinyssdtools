...
The most recent deployed version is available at <https://bcgov-env.shinyapps.io/ssdtools/>.

To install from [GitHub](https://github.com/bcgov/shinyssdtools) and run the development version locally use
...
(after setting `SHINYAPPS_TOKEN` and `SHINYAPPS_SECRET` in your repository GitHub secrets). This triggers the `deploy-app.yml` GitHub action.
