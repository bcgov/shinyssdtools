  ...
  tabsetPanel(type = "tabs",
              ...
              tabPanel(title = span(tagList(icon("stats", lib = "glyphicon"), "2. Fit")),
                       fluidRow(
                         ...
                         column(8,
                                br(),
                                shinyjs::hidden(div(id = "divDlFitPlot", 
                                                    inline(downloadButton("dlFitPlot", label = "plot .png", 
                                                                                                style = 'padding:4px; font-size:80%')))),
                                shinyjs::hidden(div(id = "divDlFitTable", 
                                                    inline(downloadButton("dlFitTable", label = "table .csv", 
                                                                                                 style = 'padding:4px; font-size:80%')))),
                                br(), br(),
                                conditionalPanel(
              ...
              tabPanel(title = span(tagList(icon("calculator"), "3. Predict")), 
                       ...
                       column(8,
                              ...
                              shinyjs::hidden(div(id = "divDlPredPlot", 
                                                  inline(downloadButton("dlPredPlot", label = "plot .png", 
                                                                        style = 'padding:4px; font-size:80%')))),
                              shinyjs::hidden(div(id = "divDlPredTable", 
                                                  inline(downloadButton("dlPredTable", label = "table .csv", 
                                                                        style = 'padding:4px; font-size:80%')))),
                              br(), br(),
                              conditionalPanel(
